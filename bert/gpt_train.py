...
from model.gpt import GPTClassifier
from gpt_preprocessing import get_batch, Corpus, batchify, batchify_docs, get_batch_docs, file_to_df
...
def run_model(batch_size, learning_rate, n_ctx, n_head, n_embd, n_layer, adaptive, bpe, masked_lm, classification, bpe_model_path, datasets, lm_corpus_file, pos_tags, dict_path, rnn, crf, config_id):
    ...
    parser.add_argument('--result_path', type=str, default='gpt_results_final.txt')
...
if __name__ == '__main__':
    ...
    configs = [
        ...
        {'id': 'gpt_science',
         ...
         'rnn': False,
         'crf': True,
         'datasets': 'kp20k;inspec;semeval;krapivin;nus',
                        ...
                        for n_head in n_heads:
                            for n_embd in n_embds:
                                for n_layer in n_layers:
                                    counter += 1
                                    run_model(batch_size, learning_rate, n_ctx, n_head, n_embd, n_layer, adaptive, bpe, masked_lm, classification, bpe_model_path, datasets, lm_corpus_file, pos_tags, dict_path, rnn, crf, config['id'])
                                    f.write('Parameters:\n')
